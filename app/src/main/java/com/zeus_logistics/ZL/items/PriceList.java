...
//        mPricelistList.add("Od 5 do 10km");
        mPricelistList.add("From 5 to 10 km");
...
//        mPricelistList.add("Superexpress - doręczenie poniżej 1 godziny");
        mPricelistList.add("Superexpress - delivery in less than 1 hour");
...
//        mPricelistPrices.add("12 PLN");
        mPricelistPrices.add("1,270.59 Naira");
//        mPricelistPrices.add("16 PLN");
        mPricelistPrices.add("1,694.18 Naira");
//        mPricelistPrices.add("20 PLN");
        mPricelistPrices.add("2,117.60 Naira");
